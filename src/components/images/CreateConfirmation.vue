...
<script>
  export default {
    ...
    created: function() {
      ...
      var body = {
        url: 'http://teamche.daneshboom.ir/base/files/create_confirmation?related_parent=null',
    ...
    methods: {
      ...
      accept: function(id, index) {
        var body = {
          url: 'http://teamche.daneshboom.ir/base/files/' + id  + '/accept/',
          token: this.$cookie.get('teamche_token'),
          method: 'post',
          result: 'acceptImagesResult'
        }
        this.$socket.emit('rest request', body)
      ...
      deny: function(id, index) {
        var body = {
          url: 'http://teamche.daneshboom.ir/base/files/' + id + '/deny/',
          token: this.$cookie.get('teamche_token'),
          method: 'post',
          result: 'denyImagesResult'
        }
        this.$socket.emit('rest request', body)
        this.items.splice(index, 1)
      },
